...
from utils import *
from configs.config_uppp_setting import setting_config
...
def main(config):
    ...
    plt.title('UNetPPP')
    plt.legend()
    plt.savefig('./log/nn_isic_unetppp_e{}_t{}.png'.format(config.epochs, tkey))
    plt.close()
