...
from models.tunet import CONFIGS as CONFIGS_TUNet
...
from engine_tu import *
import os
import sys

from utils import *
from configs.config_tu_setting import setting_config
...
def main(config):
    ...
    plt.title('TUNet')
    plt.legend()
    plt.savefig('./log/nn_isic_tunet_e{}_t{}.png'.format(config.epochs, tkey))
    plt.close()
